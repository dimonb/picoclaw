...
type AgentDefaults struct {
	...
	MaxConcurrentSessions     int                `json:"max_concurrent_sessions,omitempty" env:"PICOCLAW_AGENTS_DEFAULTS_MAX_CONCURRENT_SESSIONS"`
	SummarizeMessageThreshold int                `json:"summarize_message_threshold"     env:"PICOCLAW_AGENTS_DEFAULTS_SUMMARIZE_MESSAGE_THRESHOLD"`
	SummarizeTokenPercent     int                `json:"summarize_token_percent"         env:"PICOCLAW_AGENTS_DEFAULTS_SUMMARIZE_TOKEN_PERCENT"`
	SummarizeKeepMessages     int                `json:"summarize_keep_messages"         env:"PICOCLAW_AGENTS_DEFAULTS_SUMMARIZE_KEEP_MESSAGES"`
	JournalEnabled            bool               `json:"journal_enabled"                 env:"PICOCLAW_AGENTS_DEFAULTS_JOURNAL_ENABLED"`
...
type TelegramConfig struct {
	...
	AllowChats           FlexibleStringSlice `json:"allow_chats,omitempty"            env:"PICOCLAW_CHANNELS_TELEGRAM_ALLOW_CHATS"`
...
type ModelConfig struct {
	...
	ThinkingLevel  string         `json:"thinking_level,omitempty"` // Extended thinking / reasoning effort: off|none|minimal|low|medium|high|xhigh|adaptive
