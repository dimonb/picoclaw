...
// ExtractTrace returns a context with trace information extracted from the
// supplied carrier (typically TraceCarrier on a bus message). Returns ctx
// unchanged when the carrier is nil/empty.
