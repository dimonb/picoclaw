...
func resolveFinalResponse(
	...
	directive, content, err := parseDeliveryDirective(rawContent)
	if err != nil {
		logger.WarnCF("agent", "Ignoring invalid delivery directive", map[string]any{
			"channel":   channel,
	...
	logger.DebugCF("agent", "Resolved final delivery", fields)
